...
//define('DB_PASSWORD', 'leeqj'); # 数据库密码
define('DB_USER', 'leho');  # 数据库用户名
define('DB_PASSWORD', 'lehomysql123'); # 数据库密码
define('DB_NAME', 'yes_bbc');   # 数据库名

define('WAP_THEME_DIR', ROOT_DIR.'/wap_themes');

# 数据库服务器 -- 99% 的情况下您不需要修改此参数
define('DB_HOST', '192.168.66.205');
...
define('DEBUG_CSS',true); //是否开启css无压缩模式
define('EDITOR_ALL_SOUCECODE',false);//是否使后台可视化编辑器变为源码编辑模式
define('DONOTUSE_CSSFRAMEWORK',true);//是否禁用前台系统css框架
define('WITHOUT_AUTOPADDINGIMAGE',false);//图片处理时不需要自动补白
//update sdb_pam_account set login_password='0192023a7bbd73250516f069df18b500' where account_id=1;
